...
func (e *UserOrder) GetOrderInfo(ctx context.Context, req *userOrder.GetRequest, resp *userOrder.GetResponse) error {
	//要根据传入数据获取订单信息   mysql
...
func (e *UserOrder) UpdateStatus(ctx context.Context, req *userOrder.UpdateRequest, resp *userOrder.UpdateResponse) error {
	//根据传入数据,更新订单状态
